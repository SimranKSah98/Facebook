...
public class FriendRequestActivity extends AppCompatActivity implements  FriendRequestAdaptor.FriendRequestCom {
    ...
    private void initRecyclerView() {
        ...
        friendRequestAdaptor = new FriendRequestAdaptor(friendList, FriendRequestActivity.this);
        ...
        App.getApp().getRetrofit().create(APIinterface.class).sendRequest(friendRequest).enqueue(
                new Callback<BaseResponse<FriendRequest>>() {
                    ...
                    public void onResponse(Call<BaseResponse<FriendRequest>> call, Response<BaseResponse<FriendRequest>> response) {
                        ...
                        {
                            FriendRequest friendRequest=response.body().getData();
                            String status=friendRequest.getStatus();
                            Toast.makeText(FriendRequestActivity.this,"successful"+status,Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(Call<BaseResponse<FriendRequest>> call, Throwable t) {
                        Toast.makeText(FriendRequestActivity.this,"failed",Toast.LENGTH_SHORT).show();
